...
<template>
  <main>
    ...
    <form @submit.prevent="searchAnime">
      <input type="text" placeholder="Seach for an anime..." v-model="query" @input="handleInput" />

      <button type="submit" class="button">Search</button>
    </form>

    <div class="results" v-if="search_results.length > 0">
      <div class="result" v-for="anime in search_results" v-bind:key="anime">
    ...
    <div class="myanime" v-if="my_anime.length > 0">
      ...
      <div v-for="anime in my_anime_asc" v-bind:key="anime" class="anime">
        <img :src="anime.image" />
        <h3>{{ anime.title }}</h3>
